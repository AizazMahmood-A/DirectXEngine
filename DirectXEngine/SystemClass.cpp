...
bool SystemClass::Initialize()
{
	...
	// This object will handle rendeing all the graphics for this application.
...
void SystemClass::Run()
{
	...
	// Inittialize the message structure
	ZeroMemory(&msg, sizeof(MSG));

	// Loop untill there is a quit message from the window or the user.
	done = false;
	while (!done)
	{
		// Handle the windows meesages.
...
bool SystemClass::Frame()
{
	...
	// Check if user pressed escape and wnats to exit the application.
...
LRESULT CALLBACK SystemClass::MessageHandler(HWND hwnd, UINT umsg, WPARAM wparam, LPARAM lparam)
{
	switch (umsg)
	{
		...
		case WM_KEYUP:
		{
			// if a key is released the send it to the input object so it can unset the state for that key.
...
void SystemClass::InitializeWindows(int& screenWidth, int& screenHeight)
{
	...
	// Bring the window up on the screen and set as main focus
