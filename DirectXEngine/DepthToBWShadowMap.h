////////////////////////////////////////////////////////////////////////////////
// Filename: depthtobwshadowmap.h
////////////////////////////////////////////////////////////////////////////////
#ifndef _DEPTHTOBWSHADOWMAP_H_
#define _DEPTHTOBWSHADOWMAP_H_
...
////////////////////////////////////////////////////////////////////////////////
// Class name: DepthToBWShadowMap
////////////////////////////////////////////////////////////////////////////////
class DepthToBWShadowMap
{
private:
...
public:
    DepthToBWShadowMap();
    DepthToBWShadowMap(const DepthToBWShadowMap&);
    ~DepthToBWShadowMap();
