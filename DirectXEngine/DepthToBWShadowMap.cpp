////////////////////////////////////////////////////////////////////////////////
// Filename: DepthToBWShadowMap.cpp
////////////////////////////////////////////////////////////////////////////////
#include "DepthToBWShadowMap.h"


DepthToBWShadowMap::DepthToBWShadowMap()
{
    m_vertexShader = 0;
    m_pixelShader = 0;
    m_layout = 0;
...
DepthToBWShadowMap::DepthToBWShadowMap(const DepthToBWShadowMap& other)
{
}
...
bool DepthToBWShadowMap::Initialize(ID3D11Device* device, HWND hwnd)
{
    ...
    error = wcscpy_s(vsFilename, 128, L"../DirectXEngine/DepthToBWShadowMap.vs");
    if (error != 0)
    {
        return false;
    }
    ...
    error = wcscpy_s(psFilename, 128, L"../DirectXEngine/DepthToBWShadowMap.ps");
    if (error != 0)
    {
        return false;
    }
...
void DepthToBWShadowMap::Shutdown()
{
...
bool DepthToBWShadowMap::Render(ID3D11DeviceContext * deviceContext, int indexCount, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix,
...
bool DepthToBWShadowMap::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
    HRESULT result;
...
void DepthToBWShadowMap::ShutdownShader()
{
...
void DepthToBWShadowMap::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename)
{
    char* compileErrors;
...
bool DepthToBWShadowMap::SetShaderParameters(ID3D11DeviceContext* deviceContext, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix,
...
void DepthToBWShadowMap::RenderShader(ID3D11DeviceContext* deviceContext, int indexCount)
{
