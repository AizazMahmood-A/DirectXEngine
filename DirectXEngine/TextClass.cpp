...
bool TextClass::Initialize(ID3D11Device* device, ID3D11DeviceContext* deviceContext, int screenWidth, int screenHeight, int maxLength, FontClass* font, char* text, int positionX, int positionY, float red, float green, float blue)
{
	bool result;
...
bool TextClass::UpdateText(ID3D11DeviceContext* deviceContext, FontClass* Font, char* text, int positionX, int positionY, float red, float green, float blue)
{
	...
	// Use the font class to build the vertex array from the sentence text and sentence daw location.
